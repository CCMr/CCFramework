...
+ (UIImage *)imageNamedFromMyBundle:(NSString *)name {
    UIImage *image = [UIImage imageNamed:[@"CCFramework.bundle/TZImagePickerController.bundle" stringByAppendingPathComponent:name]];
    if (image) {
        return image;
    } else {
        image = [UIImage imageNamed:[@"Frameworks/CCFramework.framework/CCFramework.bundle/TZImagePickerController.bundle" stringByAppendingPathComponent:name]];
        if (!image) {
