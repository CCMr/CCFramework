...
+ (instancetype)tz_imagePickerBundle {
    ...
    if (tzBundle == nil) {
        NSString *path = [[NSBundle mainBundle] pathForResource:@"CCFramework.bundle/TZImagePickerController" ofType:@"bundle"];
        if (!path) {
            path = [[NSBundle mainBundle] pathForResource:@"CCFramework.bundle/TZImagePickerController" ofType:@"bundle" inDirectory:@"Frameworks/CCFramework.framework/"];
        }
