...
@implementation CCAnimatedImageView

#pragma mark - Accessors
#pragma mark Public

- (void)setAnimatedImage:(CCAnimatedImage *)animatedImage
{
...
- (CADisplayLink *)displayLink
{
    if (!_displayLink) {
        ...
        CCWeakProxy *weakProxy = [CCWeakProxy weakProxyForObject:self];
