...
- (NSDictionary *)attributesFromLabelProperties
{
    ...
    NSDictionary *attributes = @{
                                 NSFontAttributeName : _styleRecord.font,
...
- (void)removeAllNSOriginalFontAttributes
{
    ...
    [attString enumerateAttribute:@"NSOriginalFont" inRange:NSMakeRange(0, attString.length) options:0 usingBlock:^(id value, NSRange range, BOOL *stop) {
        if (value)
            [attString removeAttribute:@"NSOriginalFont" range:range];
    }];
