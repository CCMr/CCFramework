...
#import "PNColor.h"
#import "CCCountingLabel.h"

@interface PNCircleChart ()

@property (strong, nonatomic) CCCountingLabel *countingLabel;
@end
  ...
  overrideLineWidth:(NSNumber *)overrideLineWidth
{
    ...
    if (self) {
        ...
        _countingLabel = [[CCCountingLabel alloc] initWithFrame:CGRectMake(0, 0, 100.0, 50.0)];
