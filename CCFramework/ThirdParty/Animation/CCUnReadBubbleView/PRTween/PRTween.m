...
+ (id)periodWithStartCGPoint:(CGPoint)aStartPoint
                  endCGPoint:(CGPoint)anEndPoint
                    duration:(CGFloat)duration
{
    return [PRTweenCGPointLerpPeriod periodWithStartValue:[NSValue valueWithCGPoint:aStartPoint]
                                                 endValue:[NSValue valueWithCGPoint:anEndPoint]
                                                 duration:duration];
}
...
+ (id)periodWithStartCGRect:(CGRect)aStartRect
                  endCGRect:(CGRect)anEndRect
                   duration:(CGFloat)duration
{
    return [PRTweenCGRectLerpPeriod periodWithStartValue:[NSValue valueWithCGRect:aStartRect]
                                                endValue:[NSValue valueWithCGRect:anEndRect]
                                                duration:duration];
}
          ...
          completeSelector:(SEL)selector
{
    return [PRTween lerp:object
                property:property
                  period:[PRTweenCGPointLerpPeriod periodWithStartCGPoint:from endCGPoint:to duration:duration]
...
+ (PRTweenOperation *)lerp:(id)object
          ...
          completeSelector:(SEL)selector
{
    PRTweenCGPointLerpPeriod *period = [PRTweenCGPointLerpPeriod periodWithStartCGPoint:from
                                                                             endCGPoint:to
                                                                               duration:duration];
    period.delay = delay;
    return [PRTween lerp:object
...
+ (PRTweenOperation *)lerp:(id)object
                  ...
                  duration:(CGFloat)duration
{
    return [PRTweenCGPointLerp lerp:object
                           property:property
                               from:from
                                 to:to
                           duration:duration
          ...
          completeSelector:(SEL)selector
{
    return [PRTween lerp:object
                property:property
                  period:[PRTweenCGRectLerpPeriod periodWithStartCGRect:from endCGRect:to duration:duration]
          timingFunction:timingFunction
                  target:target
        completeSelector:selector];
}
...
- (PRTweenOperation *)addTweenOperation:(PRTweenOperation *)operation
{
    ...
    if (useBuiltInAnimationsWhenPossible && !operation.override) {
        ...
        if (operation.boundSetter &&
            operation.boundObject &&
        ...
        if (operation.boundSetter &&
            operation.boundObject &&
            [operation.boundObject isKindOfClass:[CALayer class]]) {
        ...
        } else if (operation.boundSetter &&
                   operation.boundObject &&
                   [operation.boundObject isKindOfClass:[UIView class]]) {
